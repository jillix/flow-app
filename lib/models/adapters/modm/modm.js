...
function request (data, callback) {
    ...
    switch (method) {
        case 'insert':
            ...
            break;
        case 'find':
            self.collection.find(data.d, data.o || {}, function (err, cursor) {
            ...
            break;
        case 'findOne':
            self.collection.findOne(data.d, data.o || {}, callback);
            break;
        case 'findAndModify':
            // TODO check arguments
            self.collection.findAndModify(data.d, data.o || {}, callback);
            break;
        case 'update':
