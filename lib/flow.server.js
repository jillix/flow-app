...
module.exports = function factory (config) {
    return Flow({
        ...
        composition: function (name, callback) {
            ...
            // server side module require path
            if (composition.module[0] === '/') {
                composition.module = this.config.paths.custom + '/' + composition.module;
            }
...
function composition (options, name, next) {
    ...
    if (composition.module[0] === '/') {
        composition.module = composition.browser || composition.module;

        // create client path
        composition.module = composition.module.split('/');
        composition.module.pop();
        composition.module = composition.module.join('/');
    } 
