    ...
    get: function (name, role, callback) {
        ...
        fs.readJson(path, function (err, composition) {
            ...
            getPackackeInfo.call(self, composition.module, function (err, moduleConfig) {
                ...
                if (moduleConfig && moduleConfig.engine) {
                    ...
                    if (moduleConfig.engine.dependencies) {
...
function getPackackeInfo (module, callback) {
    ...
    // TODO add fingerprints to custom module dependencies
    ...
    fs.readJson(path, function (err, packageInfo) {
        ...
        if (packageInfo.engine.dependencies) {
            fingerprint.addToFiles(module, packageInfo.engine.dependencies, function (err, scripts) {
                ...
                packageInfo.engine.dependencies = scripts;
