...
module.exports = function (config) {
    ...
    var clientSession = sessions(config.sessions);
    ...
    app.get('/:module/client(.:fp)?.js', function(req, res) {
        ...
        res.sendFile(config.repo + 'node_modules/' + req.params.module + '/M.js');
    });
    ...
    app.use(function (req, res) {
        res.sendFile(config.repo + 'node_modules/engine/lib/document.html');
    });
