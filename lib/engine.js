...
engine.load = function (name, role, callback) {
    ...
    var relatedItems = {instances: {}};
    relatedItems.instances[name] = true;
    
    // get composition
    Composition(name, relatedItems, role, function (err, composition) {
        ...
        Instance(require(composition.module), composition, role, callback);
    });
};
