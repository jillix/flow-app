...
function getFile (parentDir, path, callback, options) {
    ...
    var readPath = parentDir + cleanPath;
    ...
    readFile(file, readPath, cleanPath, options, hasFingerprint, callback);
};

function readFile (file, path, cleanPath, options, hasFingerprint, callback) {
