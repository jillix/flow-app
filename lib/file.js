 ...
 */
var getFile = exports.get = function getFile (file, wrap, callback, index) {
    ...
    if (cachedFile) {
        ...
        // overwrite file descriptor with the cached file, if data is missing 
        file = cachedFile;
    ...
    fs.readFile(file.read, function (err, data) {
        ...
        switch (file.type) {
            ...
            case 'application/javascript':
                ...
                if (wrap && file.clean !== 'resource.js') {
...
exports.prepareComponents = function (loadContext, callback) {
    ...
    if (
        (!loadContext.components.module || !loadContext.components.module.length) &&
