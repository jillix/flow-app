...
var app_model = require('./app/model.js');
...
function installDomains (descriptor, callback) {
    ...
    app_model.addApplicationDomains(descriptor._id, descriptor.domains, callback);
}
...
function addModuleInstanceOperations(descriptor, miid, miidObj, callback) {
    ...
    function addModuleInstanceOperationsSequential(index) {
        ...
        mod_model.addCanPerform(module, miid, canPerform.role, canPerform.name, canPerform.params, function(err, id) {
