...
function copyApplicationDependencies(descriptor, dependencies, callback) {
    ...
    function copyApplicationDependenciesSequential(index) {
        ...
        M.dir.copyDirectory(modulePath, appModuleRoot + module.getModulePath(), { createParents: true }, function(err) {
...
function installRoles(descriptor, callback) {
    ...
    for (var i in roles) {
        (function(i) {
            ...
            M.model.addRole(descriptor.appId, role.name, function(err, _id) {
...
function addModuleInstanceUses(descriptor, miid, miidObj, callback) {
    ...
    function addModuleInstanceUsesSequential(roleIndex) {
        ...
        M.model.addModuleInstance(miid, descriptor.roles[roles[roleIndex]]._id, descriptor.dependencies[module], miidObj.config, function(err, id) {
...
function addModuleInstanceOperations(descriptor, miid, miidObj, callback) {
    ...
    function addModuleInstanceOperationsSequential(index) {
        ...
        M.model.addCanPerform(module, miid, canPerform.role, canPerform.name, canPerform.params, function(err, id) {
