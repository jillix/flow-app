...
messages.API_OPR_NOT_FOUND = 'Operation "$1" not found for miid "$2" and role "$3"';
...
messages.DB_ORIENT_SQL_COMMAND_ERROR = 'Error while executing SQL command during "%1". Error: %2';
...
messages.DB_ORIENT_OPERATION_NOT_UNIQUE = 'Could not uniquely determine operation with name: $1 (miid: $2, role: $3)';
...
// TODO put these errors into cateogries:
// all errors must 
