...
messages.DB_ORIENT_NO_CLUSTER_FOR_CLASS = 'Could not find the cluster ID for class: $1';
...
error.DB_ORIENT_NOT_UNIQUE = 'DB_ORIENT_NOT_UNIQUE';
messages.DB_ORIENT_NOT_UNIQUE = 'Found duplicates in class $1 for values: $2';

error.DB_ORIENT_INVALID_RECORD = 'DB_ORIENT_INVALID_RECORD';
messages.DB_ORIENT_INVALID_RECORD = 'Invalid $1 record: $2';
