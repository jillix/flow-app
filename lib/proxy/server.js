...
net.createServer(function(socket) {
    ...
    socket.once('data', function (buffer) {
        ...
        // TODO this is not performant if the request is a POST with a lot of data in it
        //          - consider a maximum length of all the headers or
        //          - parse the headers manually until "\n\rhost:"
