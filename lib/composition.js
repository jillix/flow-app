        ...
        Module(config.module, function (err, modulePackage) {
            ...
            config = {
                ...
                "client": {
                    "name": "root",
                    "module": [
                        "view@0.1.0/view.@fef01a3.js",
                        "view@0.1.0/state.@fef01a3.js"
                    ],
                    "config": {},
                    "flow": [{}],
                    "load": ["moduleInstanceName"],
            ...
            //mergePackageComponents(config, modulePackage.components);
            //mergePackageFlow(config, modulePackage.flow, modulePackage.clientFlow);
