...
module.exports = function getComposition (name, role, callback) {
    ...
    // TODO buffer callbacks
    // TODO watch file
    fs.readJson(engine.paths.app_composition + name + '.json', function (err, config) {
...
function mergeModuleComponents (composition, components) {
    
}

function mergeModuleFlow (composition, components) {
