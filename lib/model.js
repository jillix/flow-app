...
exports.addModuleVersion = function(module, callback) {
    ...
    var vmCluster = M.config.orient.DB.getClusterByClass("VModule");
...
function getOperationId(mvid, name, callback) {
    ...
    var vrCluster = M.config.orient.DB.getClusterByClass("VRole");
    var vmvCluster = M.config.orient.DB.getClusterByClass("VModuleVersion");
...
exports.checkNonce = function( nonceID, callback ){
	...
	pongo.connect(M.config.mongoDB.name, "nonces", function( err, db ){
