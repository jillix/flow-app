...
var FlowEmitter = {
    ...
    flow: function (stream, options) {
        ...
        if (eventName[0] === '@' || eventName[0] === '/') {
            return CoreInst.request(stream, eventName, callback);
        }
