...
exports.load = function (name, callback) {
    ...
    if (!adapter) {
        return console.log('E', 'Init flow, before calling Flow.load.');
    }
...
// flow factory
exports.factory = function (emitter) {
