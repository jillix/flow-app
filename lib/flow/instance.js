 ...
 */
module.exports = function (name, callback, loaderInstance) {
    ...
    instance.composition(name, function (err, composition) {

        if (err) {
            return callback(err);
        }

        instance.module(composition.module, function (err, module) {
