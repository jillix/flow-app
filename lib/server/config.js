...
// the mono database credentials come from the wnvironment
// default we have a test password
var defaultMonoPwd = '1234';
if (!process.env.MONO_DB_PASSWORD) {
    console.error('NOTE: You are running with the default password for the mono database: ' + defaultMonoPwd + '. To overwrite it use the MONO_DB_PASSWORD environment variable.');
...
var environment = {
    "MONO_DB_PASSWORD": 'the password for the "admin" user in the "mono" Mongo database'
};
