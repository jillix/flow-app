...
function loadinstance (name, roleId, callback) {
    ...
    M.systemStore.collection('m_instances').findOne(query, {_id: 0, name: 0}, function (err, dbInstance) {
        ...
        M.systemStore.collection('m_modules').findOne({_id: dbInstance.module}, {_id: 0}, function (err, module) {
