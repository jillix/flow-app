...
function loadinstance (name, roleId, callback) {
    ...
    M.mainStore.collection('m_instances').findOne(query, {_id: 0, name: 0}, function (err, dbInstance) {
        ...
        M.mainStore.collection('m_modules').findOne({_id: dbInstance.module}, {_id: 0}, function (err, module) {
