...
var systemDb = M.db[M.config.systemDb];
...
function loadinstance (name, roleId, callback) {
    ...
    systemDb.collection('m_instances').findOne(query, {_id: 0, name: 0}, function (err, dbInstance) {
        ...
        systemDb.collection('m_modules').findOne({_id: dbInstance.module}, {_id: 0}, function (err, module) {
