...
var fs = require("fs");
var util = require(CONFIG.root + "/lib/util.js");
var connect = require("connect");

// imported functions
var parseUrl  = require("url").parse;
var send      = require(CONFIG.root + "/lib/send.js").send;
var operator  = require(CONFIG.root + "/lib/application/operator");
var route     = require(CONFIG.root + "/lib/application/router.js").route;
var orient    = require(CONFIG.root + "/lib/db/orient.js");
