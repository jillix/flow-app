...
var send      = require("./send").send;
var operator  = require(M.config.root + "/lib/application/operator");
var route     = require(M.config.root + "/lib/application/router").route;
var orient    = M.orient;
var model     = M.model;
...
orient.connect(M.config.orient, function(err, db) {
    ...
    model.getApplication(M.config.app, function(err, application) {
        ...
        model.addApplicationPort(M.config.app, port, function(err) {
