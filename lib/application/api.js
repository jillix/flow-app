...
// db connection api
process.mono.getDb = require(config.paths.SERVER_ROOT + 'dbs');

// get db clients
process.mono.config.systemDb = 'mongodb://localhost:27017/app_' + config.id;
process.mono.getDb(process.mono.config.systemDb, function(err, db) {
