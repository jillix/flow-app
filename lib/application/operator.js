...
var send            = require(CONFIG.root + "/lib/send").send;
var getSession      = require(CONFIG.root + "/lib/application/session").get;
var getOperation    = require(CONFIG.root + "/lib/model").getUserOperation;

// core operations modules
var mods    = require(CONFIG.root + "/lib/application/operations/module");
var static  = require(CONFIG.root + "/lib/application/operations/static");
var apps    = require(CONFIG.root + "/lib/application/operations/apps");
var auth    = require(CONFIG.root + "/lib/application/operations/auth");
