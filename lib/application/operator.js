...
var getSession      = require(M.config.root + "/lib/application/session").get;
var getOperation    = M.model.getUserOperation;

// core operations modules
var mods    = require(M.config.root + "/lib/application/operations/module");
var static  = require(M.config.root + "/lib/application/operations/static");
var apps    = require(M.config.root + "/lib/application/operations/apps");
var auth    = require(M.config.root + "/lib/application/operations/auth");
...
exports.operation = function(link) {
    ...
    getSession(link, function(err, session) {
        ...
        getOperation(link.operation.module, link.operation.method, session.uid, function(err, operation) {
            ...
            var file = M.config.APPLICATION_ROOT + link.session.appid + "/mono_modules/" + modulePath + "/" + operation.file;
...
function handlePostRequest(link, method) {
    ...
    // handle form data requests
        ...
        var appDir = M.config.root + "/apps/" + link.session.appid + "/";
