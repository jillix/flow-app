...
var Session = {
    ...
    set: function( callback ){
        ...
        M.model.endSession( this.sid, callback );
    },

    endAll: function( ){
        M.model.endAllUserSessions( this.uid, callback );
    },
...
//
//    M.model.endSessions( expire(), function( err ){
...
exports.get = function(link, callback) {
    ...
    // try to find session
    if (sid) {
        M.model.getSession(sid, expire(), expire(expire_time), function(err, session) {
...
exports.start = function(uid, appid, locale, data, callback) {
    ...
    M.model.startSession(session, function(err) {
...
function update( sid, data, newId, callback ){
	...
	M.model.updateSession( sid, q_update, function( err ){
