...
module.exports = function factory (instance, inputStream, disableInput) {
...
var Stream = {
    ...
    emit: function (err, data, ignore) {
        ...
        for (i = 0, l = handlers.length; i < l; ++i) {
            ...
            // TODO call data handler in next tick, return value must be queued
            data = handlers[i][1].apply(handlers[i][0], [data, this].concat(handlers[i][2])) || data;
        }
