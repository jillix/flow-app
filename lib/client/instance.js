 ...
 */
function initInstancesInLoadOrder (instance, callback, loaderInstance) {

    // put instance to loader instance dependencies
    if (loaderInstance) {
        loaderInstance._load.push(instance);
    ...
    if (dependencies) {
        ...
        // collect dependency instances to init after the loader instance is initialized
        if (loaderInstance) {
            loaderInstance._load.concat(dependencies);
        } else {
