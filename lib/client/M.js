...
(function(modules, cache, wsCache, css, fn, win, doc) {
    ...
    coreInstance.Z.on('view>', send('view>'));
    coreInstance.Z.on('model>', send('model>'));
