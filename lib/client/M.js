...
var M = (function() {
    ...
    var Mono = {
        ...
        */
        on: function(event, miid, handler) {
            ...
            //console.log('ON: ' + event + ' | EXT. MIID: ' + miid + ' | LOC. MIID: ' + this.miid);
            ...
            /*if (eventBuffer[miid] && eventBuffer[miid][event]) {
                console.log(eventBuffer[miid][event]);
                Mono.emit.apply(modules[miid], eventBuffer[miid][event]);
            }*/
        ...
        */
        emit: function(event) {
            ...
            //console.log(('miid ' + miid + ', emitted event ' + event).toUpperCase());
            ...
            if (events[miid] && events[miid][event]) {
                ...
                for (var i = 0, l = events[miid][event].length; i < l; ++i) {
                    ...
                    if (events[miid][event][i]) {
                        ...
                        if (events[miid][event][i] instanceof Array) {
    ...
    function moduleScriptCounter (miid, moduleScripts, moduleSources, callback, length) {
    ...
    function loadJS (miid, moduleSources, callback) {
        ...
        if (moduleSources.length) {
            ...
            for (var i = 0, l = moduleSources.length; i < l; ++i) {
                ...
                Mono.once(moduleSources[i], moduleScriptCounter);
                ...
                if (!moduleScripts[moduleSources[i]]) {
                    ...
                    if (typeof moduleScripts[moduleSources[i]] === 'function' || moduleScripts[moduleSources[i]] === 3) {
