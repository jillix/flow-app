...
(function(instances, modules, models, views, wsCache, css, fn, win, doc) {
    ...
    var Module = {
        ...
        view: function (name, project, callback) {
            ...
            // return an empty view instance if no name is given
            if (!name) {
                return callback('No view config or name');
            }
            
            // create view with a config object
            if (typeof name === 'object') {
                return createViewInstance.call(self, null, name, callback || project);
            }
