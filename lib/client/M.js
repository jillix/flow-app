...
var M = (function() {
    ...
    var constructor = function (target, miid, callback) {
        ...
        Mono.link('getConfig', {miid: 'core', path: miid}, function (err, config) {
            ...
            modules[miid].__ready__ = 0;
            modules[miid].__config__ = config;
            modules[miid].__target__ = target;
            ...
            if (config.html) {
                ...
                Mono.link(config.html, function (err, html) {
                    ...
                    if (++modules[miid].__ready__ === 2) {
                        initModule(modules[miid].__target__, miid, modules[miid].__config__);
                    }
                });
                
            } else {
                ++modules[miid].__ready__;
            }
            ...
            } else if (++modules[miid].__ready__ === 2) {
