...
var M = (function() {
    ...
    function modLoad (event) {
        console.log(event.srcElement);
    }
    
    function loadJS (miid, mods) {
        ...
        if (mods.length) {
            ...
            for (var i = 0, l = mods.length; i < l; ++i) {
                ...
                node.addEventListener("load", modLoad, false);
    ...
    var constructor = function (target, miid, callback) {
        ...
        Mono.link("getConfig", { miid: "core", path: miid }, function (err, config) {
            ...
            if (modulesToLoad.length > 0) {
                ...
                loadJS(miid, modulesToLoad, function () {
    ...
    constructor.wrap = function (name, module) {
        ...
        console.log(module());
        // TODO queue the module execution
        // TODO then buffer the return value
    };
