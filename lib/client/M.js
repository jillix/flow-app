...
(function(instances, modules, models, views, wsCache, css, fn, win, doc) {
    ...
    var Module = {
        ...
        view: function (name, project, callback) {
            ...
            if (typeof name === fn || typeof name === 'object') {
                return createViewInstance.call(self, null, name, !project ? name : callback || project);
            }
    ...
    function createViewInstance (cacheKey, config, callback) {
        ...
        // load model
        if (config.model) {
            return self.model(config.model, function (err, model) {
                
                if (err) {
                    return callback(err);
                }
                
                // save model for later access
                view.model = model;
