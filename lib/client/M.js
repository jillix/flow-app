...
var M = (function() {
    ...
    // TODO use moduleDeps, moduleEval is not needed
    var moduleEval = {};
    ...
    // TODO create a mono object on the module instance
    /*
        miid = {
            mono: {
                config: {},
                state: 0|1|2 // 0 = created, 1 = loading, 2 = init
                ...
                css: [linkElm],
                ws: {msgId: function}
                // custom functions? should be handled by the module?
            }
        }
    */
    ...
    */
    ...
    constructor.wrap = function (name, module) {
        // TODO rename moduleScripts to modules
