    ...
    var classes = {
        ...
        I: {
            ...
            route: function (url, fromPopstate) {
                ...
                var self = this;
                var old_url_location = win.location;
                var path = old_url_location.pathname;
                var hash = old_url_location.hash;
                var search = old_url_location.search;
                var current = old_url_location.href.split(/^(.*:)\/\/([a-z\-.]+)(:[0-9]+)?(.*)$/)[4];
                ...
                var stateEvent = {
                    ...
                    ori: self._name,
                    prev: {
                        path: old_url_location.pathname,
                        search: old_url_location.search,
                        hash: old_url_location.hash,
                        url: old_url_location.pathname + old_url_location.search + old_url_location.hash
                    },
                    _rt: true
                };
