...
(function (global, body, state) {
    ...
    //engine.eventStream = createEventStream;
    ...
    function link (name, to) {
        ...
        // create event stream object
        var transmitter = createTransmitter(instance);
        ...
        if (events[eventName]) {
            ...
            for (var i = 0, l = events[eventName].length, event; i < l; ++i) {
                ...
                if (handler) {
                    ...
                    if (handler._1) {
                        handler = null;
                        obsoleteEvents.push([events, eventName, i]);
                    }
                }
            }
     ...
     */
    function on (eventName, handler, once) {
