    ...
    function createCommonJsModulesInOrder (scripts, module_instance, callback) {
        ...
        for (var i = (scripts.length - 1), l = 0; i >= l; --i) {
            ...
            if (typeof engine.scripts[scripts[i]] === 'function' && !engine.scripts[scripts[i]]._eval) {
                    ...
                    engine.scripts[scripts[i]] = engine.scripts[scripts[i]].call(module.exports, require(module), module, module.exports, global, engine);
    ...
    function loadHandler (err, loadedModuleInstances) {
        ...
        if (++loadedModuleInstances.count === loadedModuleInstances.length) {
            ...
            for (var i = 0, l = loadedModuleInstances.length, flow, moduleInstance; i < l; ++i) {
                ...
                moduleInstance.init && moduleInstance.init();
