...
// link factory
module.exports = createTransmitter;

var EventStream = {
    
    // handler for incoming data
    data: function (handler, module_instance) {
        this._h.push([handler, module_instance || this._]);
        return this;
    },
 ...
 *
 * @public
 * @param {string} The event stream name.
 * @param {string} The destination instance.
 */
...
function createTransmitter (module_instance) {
