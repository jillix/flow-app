    ...
    switch (eventName[0]) {
      case '/':
        ...
        */
        ...
        request = http[endHandler ? 'post' : 'post']('/' + instance._name + ':' + eventName.substr(1));
...
function httpRequest (CoreInst, req, res) {
    ...
    // TODO get url data
    // does incoming messages emit errors?
    ...
    req.pipe(CoreInst.flow(res, {to: instance, emit: eventNme}));
    req.push(req.url);
}
