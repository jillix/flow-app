...
exports.request = function (instance, eventName, endHandler) {
    ...
    switch (eventName[0]) {
      case '/':
        ...
        */
        ...
        request = http[endHandler ? 'get' : 'post']('/' + instance._name + ':' + eventName.substr(1));
      ...
      case '@':
        ...
        // TODO cache sockets and reconnect on flow event
        request = websocket('wss://' + window.location.host);
        break;
...
function httpRequest (CoreInst, req, res) {
    ...
    // TODO test if res.push emits data events on client stream
    // TODO get url data
    ...
    // TODO emit flow event
    //CoreInst.link(instance, eventNme, req, res);
}
...
function wsMessage (CoreInst, msg) {
    ...
    */
    ...
    CoreInst.link(instance, eventNme, req);
    ...
    // link message to flow event
    //CoreInst.link(data.instance, data.event, msg.target);
