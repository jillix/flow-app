...
// init caches
var pojoInstances = cache('instances').pojo;
var compInstances = cache('instances').comp;
var pojoModules = cache('modules').pojo;
var compModules = cache('modules').comp;
var fileClient = cache('client').file;
...
function instanceFactory (name, module, dbInstance, callback) {
    ...
    pojoInstances.save(name, instance);
...
function loadinstance (name, roleId, callback) {
    ...
    model.factory(env.Z_INSTANCE_MODEL, function (err, instModel) {
        ...
        instModel.request({m: 'findOne', q: query, o: {fields: {_id: 0, name: 0}}}, function (err, dbInstance) {
            ...
            var module = pojoModules.get(dbInstance.module);
            if (module) {
            ...
            model.factory(env.Z_MODULE_MODEL, function (err, modModel) {
                ...
                modModel.request({m: 'findOne', q: {_id: dbInstance.module}}, function (err, module) {
                    ...
                    pojoModules.save(dbInstance.module, module);
...
function init () {
    ...
    pojoInstances.save(instance.Z.name, instance);
}
