 ...
 */
exports.client = function (stream, context) {
    ...
    File.prepareComponents(loadContext, function (err, files) {
        ...
        if (err) {
            return stream.end(500, {'Content-Type': 'text/plain; charset=utf-8'}, err.toString());
        ...
        gzip(
            ...
            function (err, data) {
                ...
                stream.write(null, client);
                stream.end(200, resHeaders);
                //res.writeHead(200, resHeaders);
                //res.end(client);
            }
        );
