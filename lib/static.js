...
exports.public = function (pathname, req, res) {
    ...
    File.get(pathname, function (err, file) {
...
exports.externalFile = function (link) {
    ...
    wrabbit.stream(url, link.query.w === "1" ? "E('" + url + "', function (require, module, exports, global, engine) {" : "", link.res);
};
...
exports.client = function (pathname, req, res) {
    ...
    var loadContext = {
        ...
        combine: 'client.js',
        components: {
            scripts: ['resource.js', 'utils.js', 'stream.js', 'flow.js', 'hub.js', 'instance.js', 'transform.js', 'engine.js']
        }
    };
