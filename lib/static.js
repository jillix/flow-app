...
function sendClient (res, removeSid) {
    ...
    fingerprint.addToFiles(null, ['engine.js', 'module.js', 'utils.js',  'link.js'], function (err, files) {
...
function getScript (link) {
    ...
    // TODO find a way to distinct module script and engine script requests
    if (!link._._name) {
