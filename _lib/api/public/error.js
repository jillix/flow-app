...
/*
 * Test if an error is an API error
 */
error.isApi = function (err) {
    return !!err && typeof err.code === 'string' && err.code.substr(0, 4) === 'API_';
};
...
error.API_SRV_APP_PORT_NOT_FOUND = 'API_SRV_APP_PORT_NOT_FOUND';
messages.API_SRV_APP_PORT_NOT_FOUND = 'Could not find the port of application: $1';
...
error.API_APP_DESCRIPTOR_VALIDATION = 'API_APP_DESCRIPTOR_VALIDATION';
messages.API_APP_DESCRIPTOR_VALIDATION = 'Application descriptor validation error for $1 ($2). Error: $3';
...
error.API_MOD_INVALID_DESCRIPTOR = 'API_MOD_INVALID_DESCRIPTOR';
messages.API_MOD_INVALID_DESCRIPTOR = 'Invalid descriptor for module: $1. Error: $2';

error.API_MOD_DESCRIPTOR_NOT_FOUND = 'API_MOD_DESCRIPTOR_NOT_FOUND';
messages.API_MOD_DESCRIPTOR_NOT_FOUND = 'Missing descriptor for module: $1';

error.API_MOD_NOT_FOUND = 'API_MOD_NOT_FOUND';
messages.API_MOD_NOT_FOUND = 'Module not found: $1';

error.API_MOD_VERSION_NOT_FOUND = 'API_MOD_VERSION_NOT_FOUND';
messages.API_MOD_VERSION_NOT_FOUND = 'Module version not found: $1';

error.API_MOD_CLEANUP_FAILED = 'API_MOD_CLEANUP_FAILED';
messages.API_MOD_CLEANUP_FAILED = 'Cleanup failed for module: $1';

error.API_MOD_INSTALLATION_FAILED = 'API_MOD_INSTALLATION_FAILED';
messages.API_MOD_INSTALLATION_FAILED = 'Installation failed for module: $1.\nError: $2';

error.API_MOD_UNINSTALL_FAILED = 'API_MOD_UNINSTALL_FAILED';
messages.API_MOD_UNINSTALL_FAILED = 'Uninstall failed for module: $1.\nError: $2';

error.API_MOD_INVALID_SOURCE_URL = 'API_MOD_INVALID_SOURCE_URL';
messages.API_MOD_INVALID_SOURCE_URL = 'Invalid source URL for module: $1';
...
error.API_REPO_MISSING_AUTHENTICATION = 'API_REPO_MISSING_AUTHENTICATION';
messages.API_REPO_MISSING_AUTHENTICATION = 'Missing authentication when accessing the repository: $1/$2/$3';
...
error.API_REPO_TAG_NOT_FOUND = 'API_REPO_TAG_NOT_FOUND';
messages.API_REPO_TAG_NOT_FOUND = 'Could not find a tag named "$2" for repository at: $1';

error.API_REPO_NOT_FOUND_FOR_URL = 'API_REPO_NOT_FOUND_FOR_URL';
messages.API_REPO_NOT_FOUND_FOR_URL = 'Repository not found for url: $1';
...
// API_MIID errors
error.API_MIID_NOT_FOUND = 'API_MIID_NOT_FOUND';
messages.API_MIID_NOT_FOUND = 'Miid not found: $1';
...
messages.API_OPR_NOT_FOUND = 'Operation "$1" not found for module: $2';
...
error.DB_MONGO_QUERY_ERROR = 'DB_MONGO_QUERY_ERROR';
messages.DB_MONGO_QUERY_ERROR = 'Error while querying MongoDB: $1\nError: $2';

//error.DB_MONGO_NO_CLUSTER_FOR_CLASS = 'DB_MONGO_NO_CLUSTER_FOR_CLASS';
//messages.DB_MONGO_NO_CLUSTER_FOR_CLASS = 'Could not find the cluster ID for class: $1';

//error.DB_MONGO_OPERATION_NOT_UNIQUE = 'DB_MONGO_OPERATION_NOT_UNIQUE';
//messages.DB_MONGO_OPERATION_NOT_UNIQUE = 'Could not uniquely determine operation with name: $1 (mvid: $2)';

//error.DB_MONGO_OPERATION_NOT_UNIQUE_PERMISSION = 'DB_MONGO_OPERATION_NOT_UNIQUE_PERMISSION';
//messages.DB_MONGO_OPERATION_NOT_UNIQUE_PERMISSION = 'Could not uniquely determine operation with name: $1 (miid: $2, role: $3)';

//error.DB_MONGO_OPERATION_NOT_COMPLETE = 'DB_MONGO_OPERATION_NOT_COMPLETE';
//messages.DB_MONGO_OPERATION_NOT_COMPLETE = 'The operation object is not complete: $1 (miid: $2, role: $3)';

//error.DB_MONGO_NOT_UNIQUE = 'DB_MONGO_NOT_UNIQUE';
//messages.DB_MONGO_NOT_UNIQUE = 'Found duplicates in class $1 for values: $2';

//error.DB_MONGO_INVALID_RECORD = 'DB_MONGO_INVALID_RECORD';
//messages.DB_MONGO_INVALID_RECORD = 'Invalid $1 record: $2';
...
error.JSON_PARSE = 'JSON_PARSE';
messages.JSON_PARSE = 'Error while parsing JSON from: $1\nError: $2';
...
error.COMMAND_EXECUTION_FAILED = 'COMMAND_EXECUTION_FAILED';
messages.COMMAND_EXECUTION_FAILED = 'Failed to execute command $1.\nError: $2';

error.APP_PID_NOT_FOUND = 'APP_PID_NOT_FOUND';
messages.APP_PID_NOT_FOUND = 'Error while trying to determine the process ID for application: $1';

error.APP_MULTIPLE_PROCESSES_FOUND = 'APP_MULTIPLE_PROCESSES_FOUND';
messages.APP_MULTIPLE_PROCESSES_FOUND = 'Found multiple processes matching the application ID: $1\nPIDs: $2';
...
messages.APP_PORT_NOT_FOUND = 'No port found for running application with pid: $1';
