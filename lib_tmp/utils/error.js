...
// API_INSTANCE errors
error.API_INSTANCE_NOT_FOUND = 'API_INSTANCE_NOT_FOUND';
messages.API_INSTANCE_NOT_FOUND = 'Instance not found: $1';
...
messages.API_OPR_NOT_FOUND_PERMISSION = 'Operation "$1" not found for instance "$2" and role "$3"';
...
//messages.DB_MONGO_OPERATION_NOT_UNIQUE_PERMISSION = 'Could not uniquely determine operation with name: $1 (instance: $2, role: $3)';

//error.DB_MONGO_OPERATION_NOT_COMPLETE = 'DB_MONGO_OPERATION_NOT_COMPLETE';
//messages.DB_MONGO_OPERATION_NOT_COMPLETE = 'The operation object is not complete: $1 (instance: $2, role: $3)';
